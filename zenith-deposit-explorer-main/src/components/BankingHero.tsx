    ...
    <header className="hero-gradient text-white py-20 px-6 rounded-2xl shadow-[0px_4px_10px_rgba(0,0,0,0.25)] mb-12 animate-fade-in relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button className="bg-black text-white px-10 py-4 text-lg font-semibold rounded-2xl hover:bg-gray-800 transition-all duration-300">
            EXPLORE PRODUCTS
          </button>
          <button className="bg-black text-white border-2 border-black px-10 py-4 text-lg font-semibold rounded-2xl hover:bg-gray-800 transition-all duration-300">
            CALCULATE RETURNS
          </button>
        </div>
      </div>
