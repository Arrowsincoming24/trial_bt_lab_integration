...
const SummarySection = () => {
  const summaryItems = [
    ...
    },
    {
      ...
      value: "CashCached Senior Plus FD (8.10% p.a.)",
      icon: "👴"
    },
    {
      title: "TAX BENEFIT",
      value: "CashCached Tax Saver FD (Section 80C)",
      icon: "💰"
    },
    {
      title: "WOMEN'S BENEFITS",
      value: "CashCached Women's FD",
      icon: "👩"
    },
    {
      title: "GREEN INVESTMENTS",
      value: "Green Rupee FD & CashCached Green Growth FD",
      icon: "🌱"
    }
  ];
